...
public class T02ClassMetadataTest {
	public static void main(String[] args) {
		...
		Class<?>[] interfaces = clazz.getInterfaces();		//interface는 여러개 implement 할 수 있으므로 getInterfaces(복수형)으로 쓴다.
		
		System.out.println("인터페이스 목록");
		for(Class<?> inf : interfaces) {
			System.out.print(inf.getName() + " | ");		//interface는 여러개 implement 할 수 있으므로 배열로 불러진다.
		}
		System.out.println();
