...
public class FileDownController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.setContentType("application/octet-stream"); // octet-stream: 바이너리 데이터
		resp.setHeader("Content-Disposition", "attachment; filename=\"" + URLEncoder.encode(fileVO.getOrignlFileNm(), "UTF-8").replace("\\+", "%20") + "\""); // attachment: 다운로드됨;filename: 다른이름으로 저장
