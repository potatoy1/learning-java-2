...
//		readCookieExam(req, resp); // 쿠키정보 읽기 예제
		...
		deleteCookieExam(req, resp); // 쿠키정보 삭제 에제
	...
	/*
	 	...
	 	1. 쿠키객체 생성하기. 사용불가문자(공백, []()=, "/?@:;)
	 	   ...
	 	   => 이외의 값(예를 들면 한글)을 사용시에는 URLEncoder.encode() 사용하여 처리함.
	 ...
	 */
		...
		out.println("<body>" + "<h1 align=\"center\">" + title + "</h1>" + "<ul>" 
