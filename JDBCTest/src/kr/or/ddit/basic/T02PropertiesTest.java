 ...
 */
// source folder에 넣으면 컴파일 대상으로 인식되서 bin파일로 자동으로 들어가지만 일반 folder에 넣으면
// 컴파일 대상이 아니므로 bin파일로 들어가지 않는다. 
// res폴더에 따로 넣는이유는 자바소스가 아닌것을 분리해서 넣기위함.
public class T02PropertiesTest {
	public static void main(String[] args) {
		...
		try {
			// 파일 읽기를 수행할 FileInputStream객체(반복자와 비슷) 생성
