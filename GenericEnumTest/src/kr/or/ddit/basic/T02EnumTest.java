 ...
 */
	// City 열거형 객체 선언(기본값을 이용하는 열거형)(서울(),부산()과 같은형태이지만 괄호생략되있음)
	...
	public enum Season { 
		...
		// private 생성자는 호출할 수 없어서 객체를 만들 수 없다. (무분별한 객체 생성 방지)
		Season(String data){
			str = data;
		}
	...
	public static void main(String[] args) {
		...
		//System.out.println(city.대전 == HomeTown.대전); => 타입이 달라서 비교 불가. eunm이 타입까지 체크해준다.(타입안전)
